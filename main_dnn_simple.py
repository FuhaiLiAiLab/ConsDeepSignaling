...
from keras_dnn_simple import RandNN, RunRandNN

# BUILD DECOMPOSED MODEL
def build_rand_nn(matrixA, matrixB, num_gene, num_pathway, layer1, layer2, layer3):
    model = RandNN().keras_rand_nn(matrixA, matrixB, num_gene, num_pathway, layer1, layer2, layer3)
    return model
...
def initial_run_dnn(matrixA, matrixB, num_gene, num_pathway, layer1, layer2, layer3,
    ...
    end_epoch = epoch
    model = build_rand_nn(matrixA, matrixB,
...
def learn_schedule_dnn(matrixA, matrixB, num_gene, num_pathway, layer1, layer2, layer3,
    ...
    schedule_epoch_list = [15, 15, 20, 20, 30]
    schedule_start_epoch_list = [15, 30, 50, 70] # FILE ENDS WITH [15, 30, 50, 70, 100]
    # INITIAL SCHEDULING
