...
from parse_file_path_dnn import ParseFile
...
class RandNN():
    ...
    def keras_rand_nn(self, matrixB, num_gene, num_pathway, layer1, layer2):
        ...
        output3 = Dense(1, activation='linear')(output2)
        pathway_model= Model(pathway_input, output3)

        output3 = pathway_model(pathway_info)
        model = Model(input_x, output3)
