...
class Output():
    ...
    def combine_path_dnn_output(self, folder_name, model_name):
        print('\n------- PathDNN PREDICTION RESULTS -------')
        ...
        merged_pred_df.to_csv('./datainfo/result/5-fold/PathDNN-prediction.csv', index = False, header = True)
...
if __name__ == "__main__":
    ...
    model_name = 'epoch_99'
    Output(dir_opt).combine_path_dnn_output(folder_name, model_name)