...
class LoadData():
    ...
    def pre_load_train(self):
        dir_opt = self.dir_opt
        train_input_df = pd.read_table('.' + dir_opt + '/filtered_data/TrainingInput_flabel.txt', delimiter = ',')
    ...
    def pre_load_test(self):
        dir_opt = self.dir_opt
        test_input_df = pd.read_table('.' + dir_opt + '/filtered_data/TestInput_flabel.txt', delimiter = ',')
