...
class RunRandNN():
    ...
    def train(self, input_num, epoch, batch_size, verbose, learning_rate, end_epoch):
        ...
        for i in range(epoch):
            ...
            tmp_training_input_df = pd.read_csv('.' + dir_opt + '/filtered_data/TrainingInput_flabel.txt', delimiter = ',')
        ...
        final_train_input_df = pd.read_csv('.' + dir_opt + '/filtered_data/TrainingInput_flabel.txt', delimiter = ',')
        ...
        final_train_input_df.to_csv(path + '/PredTrainingInput_flabel.txt', index = False, header = True)
    ...
    def test(self, verbose, path):
        ...
        final_test_input_df = pd.read_csv('.' + dir_opt + '/filtered_data/TestInput_flabel.txt', delimiter = ',')
        final_row, final_col = final_test_input_df.shape
        final_test_input_df.insert(final_col, 'Pred Score', y_pred_list, True)
        final_test_input_df.to_csv(path + '/PredTestInput_flabel.txt', index = False, header = True)
